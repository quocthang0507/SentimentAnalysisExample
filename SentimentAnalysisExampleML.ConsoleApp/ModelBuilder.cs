...
using SentimentAnalysisExampleML.Model;

namespace SentimentAnalysisExampleML.ConsoleApp
{
    public static class ModelBuilder
    {
        private static string TRAIN_DATA_FILEPATH = @"D:\GitHub\SentimentAnalysisExample\wikiDetoxAnnotated40kRows.tsv.txt";
